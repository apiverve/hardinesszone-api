// Package hardinesszone provides a Go client for the USDA Hardiness Zone API.
//
// For more information, visit: https://hardinesszone.apiverve.com?utm_source=go&utm_medium=readme
package hardinesszone
...
const (
	baseURL        = "https://api.apiverve.com/v1/hardinesszone"
	defaultTimeout = 30 * time.Second
)

// Client is the USDA Hardiness Zone API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new USDA Hardiness Zone API client.
...
// Execute makes a request to the USDA Hardiness Zone API with typed parameters.
//
...
//   - zip (required): string - The zip code to get the USDA Plant Hardiness Zone for [minLength: 5, maxLength: 5]
