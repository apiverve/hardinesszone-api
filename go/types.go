...
// Request contains the parameters for the USDA Hardiness Zone API.
//
// Parameters:
...
// ResponseData contains the data returned by the USDA Hardiness Zone API.
...
type DetailsData struct {
	...
	PlantSurvival string `json:"plantSurvival"`
}
