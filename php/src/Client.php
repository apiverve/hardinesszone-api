...
namespace APIVerve\Hardinesszone;
...
/**
 * Client for the USDA Hardiness Zone API
 *
 * @example Basic usage
 * ```php
 ...
 * ```
 *
 * @see https://hardinesszone.apiverve.com?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/hardinesszone';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\HardinesszoneClient] {$message}\n";
        }
    }
}
