# USDA Hardiness Zone API - Examples

This folder contains example code for using the USDA Hardiness Zone API across different platforms.
...
response = requests.get('https://api.apiverve.com/v1/hardinesszone',
  headers={'x-api-key': 'YOUR_API_KEY'})
data = response.json()
```
...
var response = await client.GetAsync("https://api.apiverve.com/v1/hardinesszone");
var data = await response.Content.ReadAsStringAsync();
```

## 📚 Documentation

- **API Reference:** [https://docs.apiverve.com/ref/hardinesszone](https://docs.apiverve.com/ref/hardinesszone)
