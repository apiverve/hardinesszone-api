# USDA Hardiness Zone Android SDK
...
```gradle
dependencies {
    implementation 'com.github.apiverve:hardinesszone-api:1.1.14'
}
```
...
```java
import com.apiverve.hardinesszone.USDAHardinessZoneAPIClient;
import com.apiverve.hardinesszone.APIResponse;
import com.apiverve.hardinesszone.APIException;

// Initialize the client
USDAHardinessZoneAPIClient client = new USDAHardinessZoneAPIClient("YOUR_API_KEY");

try {
    // Prepare query parameters
    Map<String, Object> parameters = new HashMap<>();
    parameters.put("zip", "97201");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/hardinesszone](https://docs.apiverve.com/ref/hardinesszone)
...
- **Documentation:** [https://docs.apiverve.com/ref/hardinesszone](https://docs.apiverve.com/ref/hardinesszone)
- **Issues:** [GitHub Issues](https://github.com/apiverve/hardinesszone-api/issues)
